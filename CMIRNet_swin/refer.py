...
class REFER:
    def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
        ...
        if dataset in ['refcoco', 'refcoco+', 'refcocog']:
            ...
            self.IMAGE_DIR = "/root/xtx/dataset/saiaprtc12"
        else:
    ...
    def showRef(self, ref, seg_box='seg'):
        ...
        if self.data['dataset'] == "refclef":
            file_name = file_name.split("/")
            file_name = file_name[-1]
        I = io.imread(osp.join(self.IMAGE_DIR, file_name))
        ax.imshow(I)
...
if __name__ == '__main__':
    refer = REFER("./data/", dataset='refclef', splitBy='berkeley')
    ...
    for ref_id in ref_ids:
        if i < 1000:
            ...
            # print('The label is %s.' % refer.Cats[ref['category_id']])
                ...
                plt.text(0, 0, sentence_raw, fontsize=12)

                plt.savefig(f"refit/{i}.png")
                plt.show()
